...
#define TAMANHO_MEMORIA2 TAMANHO_MEMORIA // Tamanho da memória de disco - MEM2
...
//#define sSP 3
#define sTECLADO 4
#define sHDD_OUT 5 // Definição para saída da memória de disco - MEM2
...
#define LOAD2 62       // "111110"; -- LOAD Rx END -- Rx <- M2[END]  Format: < inst(6) | Rx(3) | xxxxxxx >  + 16bit END
