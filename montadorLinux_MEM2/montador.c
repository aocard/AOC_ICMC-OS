            ...
            switch (op_code)
            {
                ...
                */
                ...
                case LOAD2_CODE :
                    ...
                    str_tmp1 = ConverteRegistrador(val1);
                    str_tmp2 = NumPBinString(val2);
                    sprintf(str_msg,"%s%s0000000",LOAD2,str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp2);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                ...
                /* ==============
                   Store2 End, Rx
                   ==============
									 Para store da memória de disco
                */
                ...
                case STORE2_CODE :
                    ...
                    str_tmp1 = ConverteRegistrador(val1);
                    str_tmp2 = NumPBinString(val2);
                    sprintf(str_msg,"%s%s0000000",STORE2,str_tmp1);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                    sprintf(str_msg,"%s",str_tmp2);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                ...
                case LOADINDEX2_CODE :
                    ...
                    str_tmp1 = ConverteRegistrador(val1);
                    str_tmp2 = ConverteRegistrador(val2);
                    sprintf(str_msg,"%s%s%s0000",LOADINDEX2,str_tmp1,str_tmp2);
                    free(str_tmp1);
                    free(str_tmp2);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
                ...
                */
                ...
                case STOREINDEX2_CODE :
                    ...
                    str_tmp1 = ConverteRegistrador(val1);
                    str_tmp2 = ConverteRegistrador(val2);
                    sprintf(str_msg,"%s%s%s0000",STOREINDEX2,str_tmp1,str_tmp2);
                    free(str_tmp1);
                    free(str_tmp2);
                    parser_Write_Inst(str_msg,end_cnt);
                    end_cnt += 1;
...
int BuscaInstrucao(char * nome)
{
    ...
    */
	...
	else if(strcmp(str_tmp,LOAD2_STR) == 0)
	{
		return LOAD2_CODE;
	}
	...
	else if(strcmp(str_tmp,LOADINDEX2_STR) == 0)
	{
		return LOADINDEX2_CODE;
	}
    ...
    else if (strcmp(str_tmp,STORE_STR) == 0)
    {
		...
		else if (strcmp(str_tmp,STORE2_STR) == 0)
		{
				return STORE2_CODE;
		}
    ...
    else if (strcmp(str_tmp,STOREINDEX_STR) == 0)
    {
		...
		else if (strcmp(str_tmp,STOREINDEX2_STR) == 0)
		{
			return STOREINDEX2_CODE;
		}
